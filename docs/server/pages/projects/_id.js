...
module.exports.__inject__ = function (context) {
  add("59b4d394", content, true, context)
};
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".single-post-page{margin:40px 0;padding:30px;text-align:center;box-sizing:border-box;height:100vh}.post{width:100%}@media (min-width:768px){.post{width:600px;margin:auto}}.post-title{margin:0}.post-details{padding:10px;box-sizing:border-box;border-bottom:3px solid #ccc;display:flex;justify-content:center;align-items:center;flex-direction:column}@media (min-width:768px){.post-details{flex-direction:row}}.post-detail{color:#585858;margin:0 10px}.post-feedback a{color:red;text-decoration:none}.post-feedback a:active,.post-feedback a:hover{color:salmon}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/projects/_id.vue?vue&type=template&id=02d29eb4&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"single-post-page"},[_c('ProjectID',{attrs:{"id":_vm.$route.params.id}})],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/projects/_id.vue?vue&type=template&id=02d29eb4&
...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  components: {
    ProjectID: () => __webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, 85))
  },
